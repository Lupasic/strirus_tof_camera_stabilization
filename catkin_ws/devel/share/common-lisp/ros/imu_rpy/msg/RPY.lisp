...
(cl:defmethod cl:initialize-instance :after ((m <RPY>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RPY)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_rpy-msg:<RPY> is deprecated: use imu_rpy-msg:RPY instead.")))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_rpy-msg:roll-val is deprecated.  Use imu_rpy-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_rpy-msg:pitch-val is deprecated.  Use imu_rpy-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <RPY>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_rpy-msg:yaw-val is deprecated.  Use imu_rpy-msg:yaw instead.")
  (yaw m))
